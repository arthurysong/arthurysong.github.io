...
const IndexPage = () => (
  <div style={{ 
    ...
    <div style={{ display: 'flex' }}>
      ...
      <ProfileLink link="https://www.linkedin.com/in/arthurcodes/" name="LinkedIn" />
      <span style={{ marginRight: 12 }}>|</span>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', marginTop: 32, alignItems: 'start', }}>
      ...
      <Project deployedLink="https://www.mwriter.app" img={mwriterdemo} imgAlt="mwriter demo gif" name="MWriter" description="A journaling application that can publish entries directly to Medium. Uses GitHub API to automatically import code blocks as GitHub gists during publishing. ReactJS, MongoDB, Express, GitHub & Medium API"/>
      <Project deployedLink="http://console-poker.herokuapp.com/" img={cpdemo} imgAlt="console poker demo gif" name="Console Poker" description="Retro 8-bit themed Poker application. Users can deposit real money using Stripe into their accounts and play live Poker. Ruby on Rails, WebSockets, Redux Middlewares, React, and Stripe API, Google OAuth"/>
    </div>
  </div>
)

const ProfileLink = ({ link, name}) => (
  <a style={{ marginRight: 12 }} href={link} target="_blank" >{name}</a>
)
